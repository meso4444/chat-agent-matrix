...
class SchedulerManager:
    ...
    def send_command_to_agent(self, agent_name, command):
        ...
        system_prompt = f"\n\n【System Prompt】This command is from system scheduled task, please be sure to execute python3 telegram_notifier.py 'task report...' to report the result after task completion."
