...
# ==========================================
# Layer 2: Load Instance-specific .env (if exists)
# ==========================================
...
def _deep_merge(base, override):
    """Recursively merge dictionaries, support nested configuration"""
...
# 4. Variable mapping and environment variable override
